...
function createWindow() {
    const window = new BrowserWindow({
        ...
        webPreferences: {
            ...
            sandbox: true,
            additionalArguments: [`--storage-analyzer-api-url=${encodeURIComponent(backendUrl)}`],
        },
